...
* @param tabParent QtabWidget du main pour pouvoir agir sur les onglet de
* l'onglet parent
* @param parent Widget parent
*/
HomeTabWidget::HomeTabWidget(QTabWidget &tabParent, QWidget *parent)
    : QWidget(parent), tabParent__(tabParent) {
  ...
  labelText__.setText(QString::fromUtf8(
      "Bienvenue dans AmazingMusicTrainer, une application pour apprendre les "
      "bases du solfège en s'amusant, et à votre niveau.\nCliquez sur le "
      "bouton \"Jouer\" pour lancer une partie, ou sur le bouton "
      "\"Performance\" pour voir vos progrès. Vous pouvez aussi vous deplcer à "
      "l'aide des onglets en haut à gauche"));
