...
*/
KeyboardOptWidget::KeyboardOptWidget(QWidget *parent)
    : QWidget(
          parent) //,space__(0,0,QSizePolicy::Minimum,QSizePolicy::Expanding)
{
  ...
  connect(&notesCheckBox__, SIGNAL(stateChanged(int)), this,
          SLOT(showNotes__(int)));
